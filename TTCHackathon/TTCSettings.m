...
/* API Gateway Parameters */
NSString *const kRoutePath = @"http://transit-gateway-app.borg.vchs.cfms-apps.com/ttc/routes";
NSString *const kStopsPath = @"http://transit-gateway-app.borg.vchs.cfms-apps.com/ttc/routes/%@";
